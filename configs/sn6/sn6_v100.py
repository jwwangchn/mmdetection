...
data = dict(
    ...
    train=dict(
        type=dataset_type,
        ann_file=data_root + 'annotations/sn6_train_v1_PS-RGB.json',
        img_prefix=data_root + 'train_RGB/',
