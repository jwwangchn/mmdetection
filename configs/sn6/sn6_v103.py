"""
    Mask R-CNN for SAR images, finetune on RGB images
    ...
    F1 Score = 34.28 (on training set, score threshold = 0.05)
"""
# model settings
model = dict(
    type='MaskRCNN',
...
train_pipeline = [
    ...
    dict(type='Resize', img_scale=[(1024, 1024), (900, 900), (800, 800)], multiscale_mode='value', keep_ratio=True),
...
test_pipeline = [
    ...
    dict(
        ...
        img_scale=[(1024, 1024), (900, 900), (800, 800)],
        flip=False,
        transforms=[
...
data = dict(
    ...
    train=dict(
        ...
        img_prefix=data_root + 'train_SAR/',
