"""
    ...
    F1 Score = 26.4 (on validation set, score threshold = 0.5)
"""
# model settings
model = dict(
    type='MaskRCNN',
...
img_norm_cfg = dict(
    mean=[85.16, 84.65, 98.08], std=[26.36, 26.23, 30.12], to_rgb=True)
train_pipeline = [
...
data = dict(
    ...
    val=dict(
        type=dataset_type,
        ann_file=data_root + 'annotations/sn6_val_v1_SAR-Intensity.json',
        img_prefix=data_root + 'train_SAR/',
