...
class SN6Dataset(CustomDataset):
    ...
    def __init__(self,
        ...
        super(SN6Dataset, self).__init__(ann_file,
                                pipeline,
                                data_root,
    ...
    def load_annotations(self, ann_file):
        ...
        for i in self.img_ids:
            ...
            # read the sar intensity json file
            sar_filename = info['filename']
            common_filename = info['filename'].split('_SAR-Intensity_')
            common_filename.insert(1, '_PS-RGB_')
            rgb_filename = "".join(common_filename)
            info['sar_filename'] = sar_filename
            info['rgb_filename'] = rgb_filename
